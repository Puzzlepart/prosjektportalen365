...
Risiko- og mulighetsmatrisene er blitt mer fleksible. Det er nå mulig å justere størrelse og farger, fargene baserer seg på prosenter innenfor størrelsen til matrisen. Det er også mulig å overstyre overskriftene til sannsynlighet og konsekvens aksene. Matrisene kan også settes til å bruke hele kolonnebredden i statusrapportene eller selvvalgt bredde.
