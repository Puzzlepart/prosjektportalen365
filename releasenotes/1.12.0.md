...
Velkommen til versjon 1.12.0 av Prosjektportalen 365. I denne versjonen har vi fokusert på å få løsningen tilgjengelig på engelsk, samt introdusert flere nye funksjoner og forbedringer basert på tilbakemeldinger fra brukere. Her er noen av høydepunktene i denne utgivelsen:

- **[Prosjektportalen på engelsk](#prosjektportalen-på-engelsk)** - Prosjektportalen er nå tilgjengelig på engelsk!
- **[Hjelpeinnhold er oppdatert](#hjelpeinnhold-er-oppdatert)** - Hjelpeinnholdet i Prosjektportalen er nå oppdatert for å gjenspeile de nyeste endringene.
...
- **[Prosjektnyheter](#prosjektnyheter)** - For publisering og visning av prosjektnyheter med mulighet til å opprette nyhetsartikler på et sentralt område.
...
Fra versjon **1.12** støtter Prosjektportalen nå installasjon på **engelsk**, slik at virksomheter med internasjonale behov kan bruke løsningen på sitt foretrukne språk. Installasjonen gjøres med parameteren `-Language English`, og norsk og engelsk kan eksistere side om side i samme organisasjon. [Les mer om engelsk Prosjektportalen her](https://github.com/Puzzlepart/prosjektportalen365/wiki/Prosjektportalen-p%C3%A5-engelsk)

## Hjelpeinnhold er oppdatert

Vi har også børstet støv av hele brukermanulen og oppdatert hjelpeinnholdet i Prosjektportalen, som nå gjenspeiler de nyeste endringene i løsningen. Vi har lagt til nye artikler og oppdatert eksisterende innhold for å sikre at brukerne har tilgang til relevant og oppdatert informasjon. Skjermbilder, tekster er oppdatert slik at innholdet samsvarer med den nyeste versjonen av Prosjektportalen.

![image](./assets/1.12/hjelpeinnhold.png)

Det som vises i hjelpeinnhold dialogene i Prosjektportalen kommer fra [Prosjektportalen brukermanual](https://docs.puzzlepart.com/prosjektportalen-manual/). Det er fortsatt mulig å tilpasse hjelpeinnholdet ved å overstyre sider i brukermanualen med egendefinerte sider i deres egen dokumentasjon.
