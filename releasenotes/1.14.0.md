...
- **Sentral URL virker som før**: Tenant-innstillingen `pp365_ProvisionUrl` settes fortsatt av installasjonsskriptet og brukes av Bestillingsportalen Teams-app og webdelen.
