# Kildesett: Prosjektveiviseren v6
...
> vilkår (NLOD) med kildehenvisning.
...
- [x] Dokumentmaler: alle 11 filer lastet ned og verifisert (se «Dokumentmaler» nedenfor)
- [ ] **Nynorskversjoner av dokumentmalene: FINNES IKKE på Digdirs malside** — kun bokmålsfiler
      tilbys. Avklar med Digdir/Marit om nynorsk kommer, eller om PP365 dropper nynorskmapper
      for v6-settet. *(Varsel til M1.)*
...
utredningsinstruksen lever videre *inne i* aktivitet 1 og 2.

### Planleggingsfasen (BP2 → BP3)
...
|---|---|---|
| gevinst(er) | **nyttevirkning(er)** | Begreper: «Nyttevirkninger (tidligere gevinster)». «Prosjektveiviseren gikk i 2026 over til å benytte "nyttevirkninger" fremfor "gevinster" … "Gevinster" omtales fortsatt, men det er nyttevirkninger som i hovedsak benyttes.» |
| gevinstrealisering | **nyttestyring** | Begreper: «Nyttestyring (tidligere gevinstrealisering)». Samordnet med DFØs veileder om nyttestyring. |
| gevinstrealiseringsplan | **plan for nyttestyring** (også «nyttestyringsplan») | Malen heter «Plan for nyttestyring - gevinstrealisering» — gevinstbegrepet beholdt som forklarende etterledd. Rollesiden: «nyttestyringsplanen (tidligere gevinstrealiseringsplan)». |
| gevinst**eier** | **nytteeier** — nå den *overordnede* rollen | Roller: «Nytteeier (tidligere gevinsteier) har det overordnede ansvaret for at prosjektets nyttevirkninger (gevinster) blir realisert.» |
| gevinst**ansvarlig** | **finnes ikke som direkte motsvar** — se rollemerknaden under | «Nytteansvarlig» i v6 er en *delegert* underrolle: «nytteeier [kan] delegere deler av nyttestyringsansvaret til nytteansvarlige med spesifisert nyttestyringsansvar for gitte deler av prosjektet eller virksomheten.» |
| samfunnsøkonomisk analyse | Beholdt som *begrep* og metode; ikke egen *aktivitet* (avviklet allerede i v2.6) | Begreper har definisjonen; aktiviteten «Vurdere virkninger og anbefale konsept» dekker vurderingen. |
| styringsparametere (sekskant, 6) | **sju styringsparametere** | Begreper: «Prosjektveiviseren bruker syv styringsparametere: nyttevirkninger, kostnader, tid, kvalitet, omfang, bærekraft og risiko.» |
| ledelsesprodukter | **utgått som hovedstruktur** | Versjonshistorikk v6: erstattet av tredelingen styringsdokumentasjon / produktdokumentasjon / øvrig prosjektdokumentasjon. |

### ⚠ Rollemerknad — TERM-003/TERM-004 er MOTSATT av antagelsen i planen

v6 har **snudd rollehierarkiet** i forhold til v5 (og PP365/issue #162):

- **v5:** *Gevinstansvarlig* = overordnet ansvar (porteføljenivå); *Gevinsteier* = lokal eier
  av enkeltgevinst.
...
1. **Tid**
2. **Kostnad**
3. **Nyttevirkninger (gevinster)** — sidens egen overskrift, med parentesen
4. **Kvalitet**
5. **Omfang** — «hvilke produkter prosjektet skal levere og hvilke behov disse dekker»
6. **Bærekraft** — «miljømessige, sosiale og økonomiske forhold … knyttet til relevante
   bærekraftsmål» (jf. FNs bærekraftsmål, som PP365 alt har som termsett)
7. **Risiko**

Ny planleggingsaktivitet «Definere akseptansekriterier for styringsparametrene» knytter
parameterne til akseptansekriterier og toleranser — relevant for både område G
(statusseksjoner) og område D (sjekkpunkter).
...
- **Gjennomføring:** Leder av utredningsarbeidet (ny) · Prosjektleder · Prosjektdeltaker · Interessent
- **Overføring og nyttevirkninger:** **Nytteeier** · **Nytteansvarlig** · Linjeorganisasjonen
- **Arkitektur:** Virksomhetsarkitekt · Løsningsarkitekt
- **Smidige roller (nye):** Produkteier · Produktsjef · Smidig coach/Scrum master ·
  Tverrfaglig smidig team

PP365s `Rolle`-termsett må sammenlignes term for term i område J; de smidige rollene og
«Leder av utredningsarbeidet» finnes trolig ikke i dagens termsett.
...
| Digdir-filnavn | Format | Nedlasting |
|---|---|---|
| Mandat for konseptfasen.docx | Word | <https://prosjektveiviseren.digdir.no/media/85/download> |
| Prosjektbegrunnelse_oppdatert.docx | Word | <https://prosjektveiviseren.digdir.no/media/89/download> |
| Prosjektforslag.docx | Word | <https://prosjektveiviseren.digdir.no/media/90/download> |
| Interessentanalyse_0.xlsx | Excel | <https://prosjektveiviseren.digdir.no/media/98/download> |
| Styringsdokument.docx | Word | <https://prosjektveiviseren.digdir.no/media/96/download> |
| Forenklet_styringsdokument_oppdatert_2_0.pptx | PowerPoint | <https://prosjektveiviseren.digdir.no/media/92/download> |
| Plan for nyttestyring - gevinstrealisering_0.docx | Word | <https://prosjektveiviseren.digdir.no/media/94/download> |
| nytteberegninger (gevinstberegninger)_oppdatert.xlsx | Excel | <https://prosjektveiviseren.digdir.no/media/99/download> |
| Sluttrapport.docx | Word | <https://prosjektveiviseren.digdir.no/media/95/download> |
| Konseptevalueringsrapport.docx | Word | <https://prosjektveiviseren.digdir.no/media/86/download> |

### Malpakke for små prosjekter

Fire av filene over (mandat, prosjektforslag, forenklet styringsdokument, sluttrapport) pluss:

| Digdir-filnavn | Format | Nedlasting |
|---|---|---|
| Forenklet plan for nyttestyring.docx | Word | <https://prosjektveiviseren.digdir.no/media/93/download> |

### Observasjoner for område F

- **Ingen nynorskversjoner tilbys** — i motsetning til v3-settet PP365 har i dag. Åpen sak til M1.
- Malen for gevinstrealiseringsplan heter eksakt **«Plan for nyttestyring - gevinstrealisering»**.
- **Ny mal:** Forenklet styringsdokument/prosjektkanvas (pptx!) og Forenklet plan for
  nyttestyring — «malpakke for små prosjekter» er ny i v6.
- **Utgått:** egne maler for faseplaner finnes ikke; v6 sier eksplisitt at faseplaner
  tilpasses per prosjekt. PP365s FaseplanX_v3.0-maler har ikke noe v6-motsvar.
- PowerPoint-formatet (.pptx) er nytt i malbiblioteket — sjekk at `Malbibliotek`-visningene
  i PP365 håndterer det.

---

## Viktige observasjoner for mappingarbeidet

1. **Flere av «v6-endringene» i planens antagelser er gamle.** «Gjennomføre samfunnsøkonomisk
   analyse» ble avviklet som aktivitet i **v2.6 (2017)**; faseovergangsaktivitetene
   («Gjennomgå faseplanen for …») kom i **v3.1 (2018)**; «behovet for endringer beskrives,
   ikke de endrede prosessene» er også v2.6. Siden PP365-innholdet er v3/v4-basert kan noe
   av dette allerede være reflektert — mappingen må sjekke faktisk PP365-tekst mot faktisk
   v6-tekst, ikke anta at alt er nytt.
2. **Aktivitetstallet er kraftig redusert** (25 aktiviteter + 6 BP-er mot PP365s 44+66 rader).
   v6-aktivitetene er bredere og har «bør avklare»-lister som kan brytes ned. Mappingen bør
   bruke listepunktene, ikke bare sidetitlene, som kandidater til sjekkpunkter/oppgaver.
3. **BP-sidene er sjekkpunktenes naturlige kilde** («bør vurdere»-listene), aktivitetssidene
   er oppgavenes. BP2-siden er den eneste som ikke er v6-datert (jan. 2023).
4. **URL-strukturen:** `godt-vite/` (uten «å»), `god-praksis-og-tilpasning/`,
   `prosjektfasene/`, `dokumentasjon/`, `ta-i-bruk/`. Gamle `god-praksis/gevinster/116` gir
   403. Tre gamle `god-praksis/`-sider (IT-politiske tema, PRINCE2-prinsipp,
