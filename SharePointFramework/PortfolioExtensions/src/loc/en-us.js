define([], function () {
  return {
    ...
    CatalogAdvancedLogLabel: 'Advanced log',
    CatalogLogDownloaded: 'Downloaded the template package',
    CatalogLogManifestValidated: 'Validated manifest for {0} v{1}',
    CatalogLogHubProvisioned: 'Provisioned hub content (content types, columns, lists)',
    CatalogLogTaxonomyApplied: 'Provisioned taxonomy (term sets) to the term store',
    CatalogLogExtensionAdded: 'Added project extension: {0}',
    CatalogLogListContentAdded: 'Configured list content: {0}',
    CatalogLogStored: 'Stored project template for the setup wizard',
    CatalogLogTemplateOptionsUpdated: 'Updated Template Options (Maloppsett)',
