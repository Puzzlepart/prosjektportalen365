define([], function () {
  return {
    ...
    CatalogContentFieldFallback: 'Felt',
    CatalogContentTaxonomy: 'Taksonomi',
    CatalogContentTermSets: 'Termsett',
    CatalogContentClientSidePages: 'Sider',
    CatalogContentListContent: 'Listeinnhold',
    ...
    CatalogAdvancedLogLabel: 'Avansert logg',
    CatalogLogDownloaded: 'Lastet ned malpakken',
    CatalogLogManifestValidated: 'Validerte manifest for {0} v{1}',
    CatalogLogHubProvisioned: 'Provisjonerte hub-innhold (innholdstyper, kolonner, lister)',
    CatalogLogTaxonomyApplied: 'Provisjonerte taksonomi (termsett) til termlageret',
    CatalogLogExtensionAdded: 'La til prosjektutvidelse: {0}',
    CatalogLogListContentAdded: 'Konfigurerte listeinnhold: {0}',
    CatalogLogStored: 'Lagret prosjektmal for oppsettveiviseren',
    CatalogLogTemplateOptionsUpdated: 'Oppdaterte Maloppsett',
    ...
    CatalogHistoryError: 'Kunne ikke laste versjonshistorikk.',
    CatalogContentSummaryError: 'Kunne ikke laste innholdsoversikt.',
    CatalogInstallErrorPartialNote: 'Noen endringer kan allerede være utført. Se stegene over for hva som ble fullført.',
    CatalogFilterLanguageLabel: 'Språk',
    CatalogFilterLanguageTooltip: 'Filtrer på tilgjengelig språk',
    CatalogFilterCompatibleOnly: 'Kun kompatible',
    CatalogFilterCompatibleOnlyTooltip: 'Vis kun maler som er kompatible med din Prosjektportalen-versjon',
    CatalogNoResultsTitle: 'Ingen treff',
    CatalogNoResultsDescription: 'Ingen maler samsvarer med filtrene. Juster eller tøm filtrene.',
