...
const solutionConfigFile = path.join(__dirname, `../config/generated-solution-config.json`);
...
(async () => {
    const componentManifestFiles = await glob(path.join(__dirname, `../src/**/manifest.json`));
