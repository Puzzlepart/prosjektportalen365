import { Dialog, DialogFooter, IModalProps, IDialogContentProps, DialogType } from '@fluentui/react'
...
export class BaseDialog extends React.PureComponent<IBaseDialogProps> {
  ...
  public render(): React.ReactElement<IBaseDialogProps> {
    return (
      <Dialog
        ...
        <span hidden={!this.props.version} className={styles.version}>
  ...
  private get _modalProps(): IModalProps {
    return {
      containerClassName: this._containerClassName,
