define([], function () {
  return {
    ...
    DocumentTemplateDialogScreenEditCopyInfoMessage: 'Her kan du sette **Filnavn** og **Tittel** for dokumentene og mappene som kopieres over.<br /><br />**Obs:** Mapper kopieres med alt innhold rekursivt til målmappen.<br /><br />Når du er ferdig, trykk **Start kopiering** for å starte kopieringen.',
