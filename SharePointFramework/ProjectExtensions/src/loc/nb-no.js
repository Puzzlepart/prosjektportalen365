define([], function () {
    return {
        ...
        DocumentTemplateDialogSummaryText: '{0} dokument(er) ble kopiert til prosjektområdet.',
        DocumentTemplateDialogErrorText: 'Det skjedde en feil under uthenting av dokumentmaler. Prøv igjen ved å laste siden på nytt. Kanskje malbiblioteket **{0}** ikke er satt opp riktig, eller ikke finnes?',
