define([], function() {
    return {
        ...
        TemplateListContentConfigText: 'Den valgte prosjektmalen inneholder konfigurasjon for standardinnhold og/eller prosjekttillegg. Disse er valgt som standard.',
