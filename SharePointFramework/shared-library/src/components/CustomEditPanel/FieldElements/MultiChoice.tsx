...
export const MultiChoice: FieldElementComponent = ({ field }) => {
    ...
    return (
        ...
        >
            <Combobox
                value={context.model.get<string[]>(field) ? context.model.get<string[]>(field).join(', ') : ''}
                defaultSelectedOptions={context.model.get<string[]>(field) ? context.model.get<string[]>(field) : []}
                multiselect
