 ...
 */
export function transformFieldXml(schemaXml: string, attributes: TypedHash<string> = {}, removeAttributes: string[] = ['Version', 'SourceID', 'Required', 'WebId', 'Hidden', 'List']): string {
