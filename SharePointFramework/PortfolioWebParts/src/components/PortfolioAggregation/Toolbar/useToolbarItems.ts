import { AppsListRegular, ContentView24Filled, ContentView24Regular, Filter24Filled, Filter24Regular, TextBulletListLtrRegular, bundleIcon } from '@fluentui/react-icons'
