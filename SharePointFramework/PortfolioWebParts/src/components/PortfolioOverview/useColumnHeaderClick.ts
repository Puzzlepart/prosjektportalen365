 ...
 */
export function useColumnHeaderClick(onColumnHeaderContextMenu: ReturnType<typeof useColumnHeaderContextMenu>) {
    const onColumnHeaderClick = (ev?: React.MouseEvent<HTMLElement, MouseEvent>, column?: ProjectColumn) => {
