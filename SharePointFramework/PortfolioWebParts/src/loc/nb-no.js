define([], function () {
  return {
    ...
    ModalColumnEmptyListDescription: 'Det ble ikke funnet noen elementer for denne dialogen.',
    ...
    NoProjectsFoundDescription: 'Det er ingen prosjekter som har blitt opprettet enda eller har dukket opp i søket.',
    NotSet: 'Ikke satt',
    ...
    ProjectListEmptyText: 'Søket etter prosjekter ga ingen resultater',
