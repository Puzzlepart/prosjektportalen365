define([], function () {
  return {
    ...
    DeadProjectTooltip: 'Prosjektområdet er slettet eller utilgjengelig',
    DeleteDeadProjectConfirmTitle: 'Fjern oppføring fra Prosjekter-listen?',
    DeleteDeadProjectConfirmMessage: 'Prosjektområdet finnes ikke lenger. Dette fjerner oppføringen fra listen. Handlingen kan ikke angres.',
