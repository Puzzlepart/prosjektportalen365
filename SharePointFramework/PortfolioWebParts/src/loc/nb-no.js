define([], function () {
  return {
    ...
    Provision: {
      ...
      SensitivityLabelFieldDescription: 'Hvilken følsomhetsetikett vil du bruke for området?',
      RetentionLabelFieldLabel: 'Oppbevaringsetikett',
      RetentionLabelFieldDescription: 'Hvilken oppbevaringsetikett vil du bruke for området?',
      ...
      ReadOnlyGroupFieldLabel: 'Aktiver lesetilganggruppe',
      ReadOnlyGroupFieldDescription: 'Aktiver en lesetilganggruppe for området. Dette vil gi brukere i gruppen lesetilgang til området.',
      InternalChannelFieldLabel: 'Aktiver intern kanal',
      InternalChannelFieldDescription: 'Aktiver en intern kanal for området. Dette vil gi brukere i gruppen tilgang til en intern kanal i Teams.',
