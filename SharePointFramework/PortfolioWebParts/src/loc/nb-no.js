define([], function () {
  return {
    ...
    MergedViewLabel: 'Vis alle hub-er',
    ...
    ShowMergedViewInViewSelectorDescription: 'Legg til et alternativ i visningsvelgeren for å vise sammenslått data fra alle konfigurerte hub-er samtidig.',
