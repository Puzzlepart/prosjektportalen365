define([], function () {
  return {
    ...
    ArchiveOverview: {
      ...
      StatusDescArchived: 'Elementet er arkivert.',
      StatusDescToArchive: 'Elementet står i kø og venter på arkivering.',
      StatusDescFailed: 'Arkiveringen feilet og må følges opp.',
      StatusDescWarning: 'Elementet ble arkivert, men med advarsler.',
      ActivityLevelTooltip: 'Høy: arkivert siste døgn. Middels: siste uke. Lav: siste måned. Ingen aktivitet: mer enn en måned siden, eller aldri.',
      SettingsComingSoonLabel: 'Innstillinger for arkiv-dashbordet er ikke tilgjengelig ennå.',
