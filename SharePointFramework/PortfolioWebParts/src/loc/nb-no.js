define([], function () {
  return {
    ...
    ArchiveOverview: {
      DashboardTitle: 'Arkiv-dashboard',
      RefreshLabel: 'Oppdater',
      LoadingLabel: 'Laster...',
      DayRange7Label: 'Siste 7 dager',
      DayRange16Label: 'Siste 16 dager',
      DayRange30Label: 'Siste 30 dager',
      DayRange180Label: 'Siste 180 dager',
      DayRange365Label: 'Siste 365 dager',
      NavOversikt: 'Oversikt',
      NavProsjekter: 'Prosjekter',
      NavDokumenter: 'Dokumenter',
      NavLister: 'Lister',
      NavArkivlogg: 'Arkivlogg',
      NavInnstillinger: 'Innstillinger',
      NavHjelp: 'Hjelp',
      LoadingDataLabel: 'Henter arkivdata...',
      ErrorTitle: 'Kunne ikke hente arkivdata',
      PendingTitle: 'Pending',
      ToArchiveCardTitle: 'Til arkivering',
      ToArchiveCardDescription: 'Disse elementene er klare for arkivering.',
      FailedCardTitle: 'Feilet arkivering',
      FailedCardDescription: 'Disse elementene kunne ikke arkiveres.',
      ViewDetailsLabel: 'Se detaljer',
      ProjectOverviewTitle: 'Prosjektoversikt',
      ColumnProjectName: 'Prosjektnavn',
      ColumnLastArchived: 'Sist arkivert',
      ColumnActivityLevel: 'Aktivitetsnivå',
      ColumnStatus: 'Status',
      ColumnNextArchive: 'Neste arkivering',
      ActivityHigh: 'Høy',
      ActivityMedium: 'Middels',
      ActivityLow: 'Lav',
      ActivityNone: 'Ingen aktivitet',
      StatusUpdated: 'Oppdatert',
      StatusWarning: 'Advarsel',
      StatusNeverArchived: 'Aldri arkivert',
      SeeAllProjectsLabel: 'Se alle prosjekter',
      ArchiveStatusTitle: 'Arkivstatus',
      NoArchiveDataLabel: 'Ingen arkivdata funnet.',
      SeeAllElementsLabel: 'Se alle elementer',
      StatusLabelArchived: 'Arkivert',
      StatusLabelToArchive: 'Til arkiv',
      StatusLabelFailed: 'Feilet',
      StatusLabelWarning: 'Advarsel',
      StatusValueArchived: 'Arkivert',
      StatusValueToArchive: 'Til arkiv',
      StatusValueFailed: 'Feil',
      StatusValueWarning: 'Advarsel',
      QuickOverviewTitle: 'Hurtigoversikt',
      QuickStatArchivedLabel: 'Elementer arkivert',
      QuickStatToArchiveLabel: 'Til arkivering',
      QuickStatFailedLabel: 'Feilede elementer',
      QuickStatWarningLabel: 'Elementer med advarsel',
      AboutArchiveStatusTitle: 'Om arkivstatus',
      AboutArchiveStatusDescription: 'Statusene viser hvor elementene befinner seg i arkiveringsprosessen.',
      ReadMoreLabel: 'Les mer om arkivstatus',
      NeverArchivedLabel: 'Aldri arkivert',
      TodayAtLabel: 'i dag, {0}',
      YesterdayAtLabel: 'i går, {0}',
      ActivityChartTitle: 'Arkiveringsaktivitet – siste {0} dager',
      ActivityChartLegend: 'Elementer arkivert',
      ProsjekterViewTitle: 'Prosjekter – arkiverte dokumenter',
      ColumnDocument: 'Dokument',
      ColumnDateArchived: 'Dato arkivert',
      NoDocumentsLabel: 'Ingen arkiverte dokumenter funnet.',
      ListerViewTitle: 'Lister – arkiverte lister',
      ColumnList: 'Liste',
      NoListsLabel: 'Ingen arkiverte lister funnet.',
      StatTotalLabel: 'Totalt',
      ProsjekterSearchPlaceholder: 'Søk i prosjekter...',
      FilterButtonLabel: 'Filtrer',
      ExportButtonLabel: 'Eksporter til Excel',
      DokumenterSearchPlaceholder: 'Søk i dokumenter...',
      ListerSearchPlaceholder: 'Søk i lister...',
      ArkivloggSearchPlaceholder: 'Søk i arkivlogg...',
      ColumnScope: 'Omfang',
      ColumnElement: 'Element',
      ScopeLabelDocument: 'Dokument',
      ScopeLabelList: 'Liste',
      NoLogItemsLabel: 'Ingen oppføringer funnet.'
    }
  }
})
