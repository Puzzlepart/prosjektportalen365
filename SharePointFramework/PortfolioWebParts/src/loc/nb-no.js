define([], function () {
  return {
    ...
    ResourceAllocationListLabel: 'Ressursallokering',
    ResourceAllocationListUrl: 'Lists/Ressursallokering/AllItems.aspx',
    ResourceAllocationInfoText: 'Ressursallokering eller fravær som gjelder på tvers av prosjekter legges inn i den <A HREF="../Lists/Ressursallokering/AllItems.aspx">sentrale ressursallokeringslisten</A>. Disse oppføringene vil vises med blå og rød (fravær) farge i tabellen under. Prosjektallokeringer vises med grønn farge. Fargestyrken til allokeringen baserer seg på allokeringsprosenten. <br/><br/>Merk: Visningen baserer seg på søk, så innholdet i visningen oppdaterer seg ikke umiddelbart etter at endringer er utført.<br/><br/>Tips: For å zoome inn/ut i tidslinje, bruk ALT+Musehjul eller CTRL+Musehjul. For å navigere frem og tilbake i tid kan du bruke SHIFT+Musehjul.',
