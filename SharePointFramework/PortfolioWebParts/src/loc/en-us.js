define([], function () {
  return {
    ...
    ColumnRenderOptionModalInfoTextTemplateDescription: 'Template for info text. Use {{GtMeasurementOWSCHCS}} to display the measurement indicator, {{GtStartValueOWSNMBR}} to display the starting value, and {{GtDesiredValueOWSNMBR}} to display the target. You can also use other column names from the benefit overview.',
    ColumnRenderOptionModalInfoTextTemplateLabel: 'Template for infotext',
    ColumnRenderOptionModalLinkTextLabel: 'Linktext',
