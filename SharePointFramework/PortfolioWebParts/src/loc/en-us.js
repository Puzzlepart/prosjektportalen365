define([], function () {
  return {
    ...
    ArchiveOverview: {
      ...
      StatusDescArchived: 'The element has been successfully archived.',
      StatusDescToArchive: 'The element is queued and waiting to be archived.',
      StatusDescFailed: 'Archiving failed and needs attention.',
      StatusDescWarning: 'The element was archived, but with warnings.',
      ActivityLevelTooltip: 'High: archived within the last day. Medium: within the last week. Low: within the last month. No activity: more than a month ago, or never.',
      SettingsComingSoonLabel: 'Settings for the archive dashboard are not available yet.',
