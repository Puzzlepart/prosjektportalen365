define([], function () {
    return {
        ...
        DataSourceLevelDescription: 'Select level for data source. Only data sources with this level will be available in the web part.',
        ...
        ProgramAdministrationAddChildsButtonText: 'Add projects',
        ...
        ProgramAdministrationInfoMessage: 'Select one or more projects you want to link to the site. The site will appear as a parent for the projects that have been selected under Project Information.',
        ProgramAdministrationSearchBoxPlaceholder: 'Search the program site...',
        ProgramRemoveChildsButtonText: 'Remove child sites',
        ProgramTimelineInfoText: 'All the projects with start and end dates associated with the area are listed here. To zoom in/out in timeline: ALT+Mouse wheel.',
