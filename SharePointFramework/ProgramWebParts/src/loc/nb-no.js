define([], function () {
  return {
    ...
    ProgramAdministrationAddChildsButtonDescription: 'Her får du muligheten til å legge til underordnede områder. Disse vil dukke opp i aggregerte oversikter og tidslinje inne på området.',
