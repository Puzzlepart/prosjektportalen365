define([], function () {
    return {
        ...
        PortfolioOverviewDataFetchError: 'Det skjedde en feil under henting av data for programoversikten. Vennligst prøv igjen senere.<br/><br/> **Detaljert feilmelding:**<br/> `{0}`',
        PortfolioOverviewDataFetchErrorView: 'Det skjedde en feil under henting av data for programoversikten for visning **{0}**. Vennligst prøv igjen senere, eller prøv en annen visning.<br/><br/> **Detaljert feilmelding:**<br/> `{1}`',
    }
})
