...
import { Popover, PopoverSurface, PopoverTrigger, mergeClasses } from '@fluentui/react-components'
  ...
  return (
    <Popover withArrow positioning='below' open={open} onOpenChange={handleOpenChange}>
      <PopoverTrigger disableButtonEnhancement>
        <li
          className={mergeClasses(className, phasesLength > 6 && styles.altPadding)}
          ref={targetRef}
        >
