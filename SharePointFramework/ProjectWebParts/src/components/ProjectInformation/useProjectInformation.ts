...
import { IProjectInformationProps, IProjectInformationState, IProjectInformationUrlHash } from './types'
...
export const useProjectInformation = (props: IProjectInformationProps) => {
    ...
    const onSyncProperties = async (force: boolean = false): Promise<void> => {
        ...
        setState({ ...state, progress: { title: strings.SyncProjectPropertiesProgressLabel, progress: {} } })
