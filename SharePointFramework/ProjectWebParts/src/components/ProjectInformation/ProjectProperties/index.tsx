...
export const ProjectProperties: FC<IProjectPropertiesProps> = (props) => {
  ...
  const nonEmptyProperties =
    props.properties?.filter(({ empty }) => !empty) ?? []
      ...
      <div className={styles.projectProperties}>
        <Pivot>
          ...
          {context.props.isSiteAdmin && (
            <PivotItem
              headerText={strings.ExternalUsersConfigText}
            ...
            >
              <div className={styles.pivotItem}>
                ...
                <UserMessage
                  hidden={
                    !stringIsNullOrEmpty(context.state.data.propertiesListId)
                  }
                  className={styles.pivotItemUserMessage}
                ...
                />
                <div
                  hidden={stringIsNullOrEmpty(
                    context.state.data.propertiesListId
                  )}
                >
                  {props.properties.map((model, idx) => (
                    <ProjectProperty
                      ...
                      onFieldExternalChanged={
                        context.props.onFieldExternalChanged
                      }
