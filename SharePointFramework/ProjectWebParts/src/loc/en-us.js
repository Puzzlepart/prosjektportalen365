define([], function () {
  return {
    ...
    ChildProjectAdminLabel: 'Manage subareas',
    CloseText: 'Close',
    ColorPickerStrings: {
      blue: 'Blue',
      green: 'Green',
    ...
    CreateParentModalSubText: 'Do you want to turn the area into a parent area? This action is not reversible.',
    CreateParentModalTitle: 'Parent area',
    CreateParentProjectLabel: 'Convert to parent area',
    ...
    ExternalUsersConfigInfoText: 'Here fields/columns to be displayed to external users/guests are configured. <br /> <br /> Fields/columns to be displayed to users in the organization are configured in the portfolio area by the administrator.',
    ...
    IdeaConfigurationDescription: 'Which configuration should be used for synchronizing ideas?',
    IdeaConfigurationTitle: 'Idea configuration',
    IdeaProjectDataTitle: 'Project data',
    ...
    ParentProjectsGroupName: 'Parent projects', //----------------------------Riktig ordbruk?-------------
    ParentProjectsHeaderText: 'Parent projects', //----------------------------Riktig ordbruk?-------------
    ...
    PhaseLabel: 'Phase',
    PhaseSitePageFoundDescription: 'Changes to this phase will also result in changes to the front page of the project.<br /><br />Page _{0}_ for phase found. This page will be used as the front page for the project. Press **Yes** to continue.',
    PhaseSitePageNotFoundDescription: 'Dynamic front page is enabled.<br /><br />Page _{0}_ for phase not found, please create. Pressing **Yes** will not change the front page.',
    ...
    ProjectPhasesFetchDataError: 'You do not have access to view this web part.<br/><br/>You must either have access to the portfolio area, or the project must be exempt from the portfolio area.',
    ...
    ProjectTimelineListInfoText: 'The list items for the project are listed here. Here you can edit and add new elements. This will sync to the list on the hub area. To zoom in/out in timeline: ALT+Mouse wheel',
    PublishedStatusReport: 'Published',
    PublishReportButtonText: 'Publish',
    PublishReportSpinnerText: 'Please wait while the status report is being published...',
    RedoText: 'Change',
    RevertDefaultColorConfigurationText: 'Use default',
    RiskMatrixConfigurationFolder: 'Risk matrix',
    RiskMatrixGroupName: 'Risk Matrix',
    RiskMatrixManualConfigurationPathDefaltValue: 'standard-konfigurasjon.json', //----------------Hva skal stå her?-----------------
    ...
    SyncProjectModalSubText: 'If you syncronize project data, all project properties will be replaced with project properties from the project data list. This will also sync to the hub area. If you want to continue, press \'Syncronize\'', //-----------er \'synkroniser\' en knapp eller bare kursiv?------------
    SyncProjectModalTitle: 'Retrieve project data from idea',
    ...
    UseIdeaProcessingCalloutText: 'If idea processing functionality is used for synchronizing project properties, this field must be activated to be able to synchronize project properties from the \'Project data\' list down to the project. If there is an element in the \'Project data\' list with the same \'Area address\', a button will appear to synchronize project properties. If this is not the case, no button will appear to synchronize project properties.',
    UseIdeaProcessingFieldLabel: 'Use idea processing functionality',
