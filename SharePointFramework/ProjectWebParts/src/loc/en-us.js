define([], function () {
  return {
    ...
    ExternalUsersConfigInfoText: 'Here fields/columns to be displayed to external users/guests are configured. <br /> <br /> Fields/columns to be displayed to users in the organization are configured in the portfolio site by the administrator.',
    ...
    SyncProjectModalSubText: 'If you syncronize project data, all project properties will be replaced with project properties from the project data list. This will also sync to the hubsite. If you want to continue, press \'Syncronize\'',
