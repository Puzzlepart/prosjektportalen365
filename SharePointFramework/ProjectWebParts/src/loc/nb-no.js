define([], function () {
  return {
    ...
    No: 'Nei',
    NoLocalPropertiesListWarningText: 'Du må synkronisere prosjektinformasjonen før du kan konfigurere felter/kolonner som skal vises for eksterne brukere/gjester.<br /><br />Dette gjøres ved å klikke på knappen \'Synkroniser prosjektegenskaper\'.',
